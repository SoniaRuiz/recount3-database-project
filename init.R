...
# Source - https://stackoverflow.com/a/15170774
# Posted by IRTFM, modified by community. See post 'Timeline' for change history
...
suppressPackageStartupMessages({
  library(tidyverse, lib.loc = "/usr/local/Cluster-Apps/R/4.3.1-icelake/lib64/R/library")
  library(XML, lib.loc = "/usr/local/Cluster-Apps/R/4.3.1-icelake/lib64/R/library")
  library(GenomeInfoDb, lib.loc = "/usr/local/Cluster-Apps/R/4.3.1-icelake/lib64/R/library")
  library(GenomicRanges, lib.loc = "/usr/local/Cluster-Apps/R/4.3.1-icelake/lib64/R/library")
  library(DBI, lib.loc = "/usr/local/Cluster-Apps/R/4.3.1-icelake/lib64/R/library")
  library(doParallel, lib.loc = "/usr/local/Cluster-Apps/R/4.3.1-icelake/lib64/R/library")
  library(recount3)
})
...
base_folder <- "/home/sg2173/PROJECTS/srRNAseq/recount3-database-project/"
...
args <-
  list(
    ...
    dependencies_folder = file.path("/home/sg2173/rds/rds-rytenlab-2Hstq49W5EY/sruiz/srRNAseq/recount3-database-project/dependencies"),
    ...
    gtf_version = "URA",
    gtf_path = "/home/sg2173/rds/rds-rytenlab-2Hstq49W5EY/sruiz/reference/ensembl/Homo_sapiens.GRCh38.116.chr.gtf",
