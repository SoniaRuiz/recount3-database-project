...
GO Enrichment of the genes containing introns with higher levels of MSR_A in AD samples compared to control samples.

- Total common introns (n= 148,413). 
- Background genes (n=15,617). These are all genes parenting all (n= 148,413) introns.
- Introns with increasing levels of MSR_A in AD vs control (n=9,292). Genes parenting those introns n=6,025 (these are the genes evaluated on the GO enrichment analysis).
- Introns with decreasing levels of MSR_A in AD vs control (n=6,645).
- Introns with the same value n=132,476. These are majoritarily MSR_A=0.
